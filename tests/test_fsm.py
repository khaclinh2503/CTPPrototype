...
class TestFSMIntegration:
    ...
    def test_toll_debuff_turns_decrements_in_end_turn(self, controller, board):
        """tile.toll_debuff_turns=3 → sau _do_end_turn(), toll_debuff_turns == 2."""
        ...
        assert tile.toll_debuff_turns == 2

    def test_toll_debuff_turns_decrements_to_zero(self, controller, board):
        """tile.toll_debuff_turns=1 → sau END_TURN, toll_debuff_turns=0 và rate reset."""
        tile = board.get_tile(2)
        tile.toll_debuff_turns = 1
        tile.toll_debuff_rate = 0.0
